    ...
    def __init__(self, w, h):
        ...
        def get_row_count():
            ...
            try:
                ...
                cursor.execute('SELECT COUNT(*) FROM "GameSchema".users')
                ...
                print("Error retrieving row count:", error)
        ...
        def load_car():
            ...
            if (get_row_count() == 1):
            ...
            elif (get_row_count() == 2):
                image = self.CARS[0]
                self.player = PlayerVehicle(image, self.player_x, self.player_y)
                self.player_group.add(self.player)
                image2 = self.CARS[1]
                self.player2 = PlayerVehicle(image2, self.player_x2, self.player_y)
                self.player_group.add(self.player2)
            elif (get_row_count() == 3):
                image = self.CARS[0]
                self.player = PlayerVehicle(image, self.player_x, self.player_y)
                self.player_group.add(self.player)
                image2 = self.CARS[1]
                ...
                self.player_group.add(self.player2)
                image3 = self.CARS[2]
                self.player2 = PlayerVehicle(image3, self.player_x2, self.player_y)
                self.player_group.add(self.player2)
